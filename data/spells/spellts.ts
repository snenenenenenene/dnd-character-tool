...
Gift of Alacrity	Divination DC	1 Minute	Touch	8 hours	V, S
...
export const spells: Spell[] = [
  ...
  },
  {
    name: "Chaos Bolt",
    description:
      "You hurl an undulating, warbling mass of chaotic energy at one creature in range. Make a ranged spell attack against the target. On a hit, the target takes 2d8 + 1d6 damage. Choose one of the d8s. The number rolled on that die determines the attack’s damage type, as shown below. At Higher Levels. If you roll the same number on both d8s, the chaotic energy leaps from the target to a different creature of your choice within 30 feet of it. Make a new attack roll against the new target, and make a new damage roll, which could cause the chaotic energy to leap again. A creature can be targeted only once by each casting of this spell. Acid. The target takes 2d8 acid damage. Cold. The target takes 2d8 cold damage. Fire. The target takes 2d8 fire damage. Force. The target takes 2d8 force damage. Lightning. The target takes 2d8 lightning damage. Poison. The target takes 2d8 poison damage. Psychic. The target takes 2d8 psychic damage. Thunder. The target takes 2d8 thunder damage.",
    school: "Evocation",
    castingTime: "1 Action",
    range: "120 feet",
    duration: "Instantaneous",
